...
setup(name='pyFF',
      ...
      tests_require=['pbr', 'coverage', 'nose>=1.0', 'mock', 'mako', 'mockredispy', 'testfixtures', 'wsgi_intercept'],
      ...
      entry_points={
          'console_scripts': ['pyff=pyff.md:main', 'pyffd=pyff.mdx:main', 'pyffq=pyff.mdq.main'],
          'paste.app_factory': [
