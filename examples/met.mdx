- when update:
   - load:
      ...
      - "http://ds.aai.arnes.si/metadata/aai.arnes.si.signed.xml"
      - "https://directory.tuakiri.ac.nz/metadata/tuakiri-metadata-signed.xml"
      - "https://caf-shibops.ca/CoreServices/cafshib_metadata_signed.xml"
      ...
      - "https://login.aaiedu.hr/sso/module.php/aggregator/?id=aaieduhr_edugain"
