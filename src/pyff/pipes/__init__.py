...
.. function:: pipe(md,t,name,args,id)

    :param md: Active repository.
    :type md: MDRepository instance
    :param t: Current working document. This variable may be None until select is passed in the plumbing.
    :type t: ElementTree
    :param name: the @Name attribute of the EntityDescriptor set
    :type name: string
    :param args: the list or dict of arguments to the pipe from the plumbing config.
    :type args: any
    :param id: an identifier of the plumbing instance. This is typically the filename of the plumbing config with the extension stripped off but in the case of a *fork*ed plumbing this may be None or an autogenerated id.
...
of the pipeline to get cancelled.
    """
